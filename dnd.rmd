...
ep = 0.2
ep1 = sum(ac >= 10) / count
ep2 = sum(ac >= 10 & ac <= 12) / count
ex = sort(ac$AC)[[count * ep]]
ez = (ex - mean) / sd
```

Empirical Percentage of Points Above 10: $$`r round(ep1*100, 1)`\%$$

Empirical Percentage of Points Between 10 & 12: $$`r round(ep2*100, 1)`\%$$

Empirical 20th Percentile Data Point: $$x = `r round(ex, 0)`$$

Empirical 20th Percentile Z-Score: $$z = `r round(ez, 2)`$$